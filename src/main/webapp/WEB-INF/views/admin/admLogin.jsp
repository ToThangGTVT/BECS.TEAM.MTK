                    ...
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header">
                                ...
                                <div class="alert alert-danger" role="alert" id="danger-msg" >
                                    <span>${message}</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="<%=request.getContextPath()%>/admin/login" method="post">
                                    <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Email</label><input class="form-control py-4" id="inputEmailAddress" name="user" type="text" placeholder="Enter email address" /></div>
